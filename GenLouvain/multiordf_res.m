function [S,Q,B] = multiordf_res(A,gamma,omega)
%MULTIORD  Multislice community detection for ordered slices, matrix version
%   Version 0.99, August 26, 2011.
%
%   [S,Q] = MULTIORD(A,GAMMA,OMEGA) with A a cell array of square symmetric
...
%   connecting nearest-neighbor ordered slices, and GAMMA the resolution parameter.  
